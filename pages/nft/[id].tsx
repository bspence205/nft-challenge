...
{/* Left */}
    ...
    <div className='lg:col-span-4 bg-gradient-to-br from-cyan-500 to-rose-500'>
       ...
       lg:min-h-screen'>
          ...
          src="https://links.papareact.com/8sg" alt="bored ape nft" />
           </div>
  ...
  <div className='flex flex-1 flex-col p-12 lg:col-span-6'>
    {/* Header */}
        ...
        <p className='text-center text-sm text-rose-400'>
            You're logged in with the wallet {address.substring(0, 5)}...{address.substring(address.length - 5)}
        </p>
        )}
    ...
    {/* Content */}
        ...
        lg:space-y-0'>
            ...
            <h1 className='text-3xl font-bold lg:text-5xl lg:font-extrabold'>
                The Corgi Ape Yacht Club | NFT Drop
            </h1>
